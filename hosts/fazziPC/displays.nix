    ...
    edid = {
      ...
      packages = [
        ...
        (pkgs.runCommand "M27Q-EDID" {} ''
          ...
          
          AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAK+Q
          EOF
        '')
      ];
    };
