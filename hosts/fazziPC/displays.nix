    ...
    edid = {
      ...
      packages = [
        ...
        (pkgs.runCommand "M27Q-EDID" {} ''
          ...
          aKCgKFAYIKgEgGghAAAaAAAA/QAwr/PzRgEKICAgICAgAAAA/ABNMjdRCiAgICAgICAgAAAA/wAy
          MDEyMEIwMDAwMDEKAh4CAy9ASQIDERIEL5A/BSMJFweDAQAAbRoAAAIBILAAAAAAAADjBeMB5gYF
