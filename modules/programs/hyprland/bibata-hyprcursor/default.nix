# thanks diniamo!!
# SOURCE: https://github.com/diniamo/niqspkgs/blob/main/pkgs/bibata-hyprcursor/default.nix
{
  stdenvNoCC,
  fetchFromGitHub,
  python3,
...
in
  assert elem variant ["modern" "modern-right" "original" "original-right"];
